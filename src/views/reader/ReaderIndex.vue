        ...
        <el-dialog title="添加读者" :visible.sync="addFormVisible" width="600px">
            <el-form :model="addForm">
                ...
                <el-form-item label="生日" label-width="15%" required>
                    <el-date-picker v-model="addForm.birthday" type="date" placeholder="选择日期" style="width: calc(600px - 26%);">
                    </el-date-picker>
                </el-form-item>
                ...
                <el-form-item label="手机号" label-width="15%" required>
                    <el-input v-model="addForm.tel" autocomplete="off" placeholder="请输入手机号"></el-input>
                </el-form-item>
